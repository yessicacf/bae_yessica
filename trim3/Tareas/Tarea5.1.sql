...
-- 3- Ingrese algunos los siguientes registros:
    INSERT TO FACTURAS(0000000100, 1,'ESCUADRA 20CM', 2.50, 20);
    INSERT TO FACTURAS(0000000100, 2,'ESCUADRA 50CM', 5.00, 30);
    INSERT TO FACTURAS(0000000100, 3,'GOMA LAPIZ-TINTA', 0.35, 100);
    INSERT TO FACTURAS(0000000102, 1,'LAPICES COLORESX6', 4.40, 50);
    INSERT TO FACTURAS(0000000102, 2,'LAPICES COLORESX12', 8.00, 60);
    INSERT TO FACTURAS(0000000255, 1,'LAPICES COLORESX24', 12.35, 100);
    INSERT TO FACTURAS(0000000567, 1,'COMPAS PLASTICO', 12.00, 50);
    INSERT TO FACTURAS(0000000567, 2,'COMPAS METAL', 18.90, 80);
